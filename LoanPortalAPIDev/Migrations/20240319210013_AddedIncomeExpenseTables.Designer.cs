...
namespace LoanPortalAPIDev.Migrations
{
    ...
    [Migration("20240319210013_AddedIncomeExpenseTables")]
    partial class AddedIncomeExpenseTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("LoanPortalAPIDev.Data.PQLC_Loan", b =>
                {
                    ...
                    b.HasOne("LoanPortalAPIDev.Data.PQLC_Loan+Expense", "expenses")
                        .WithMany()
                        .HasForeignKey("expensesID");

                    b.HasOne("LoanPortalAPIDev.Data.PQLC_Loan+Income", "income")
                        .WithMany()
